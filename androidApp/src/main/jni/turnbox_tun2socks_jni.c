...
Java_org_turnbox_app_vpn_service_TurnboxVpnService_startTun2socksNative(
...
Java_org_turnbox_app_vpn_service_TurnboxVpnService_stopTun2socksNative(
...
Java_org_turnbox_app_vpn_service_TurnboxVpnService_getTun2socksStatsNative(
    JNIEnv *env, jobject thiz)
{
    size_t tx_packets = 0;
    size_t tx_bytes = 0;
